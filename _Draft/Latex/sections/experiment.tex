...
\begin{table}[H]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \cline{2-4}
    \multicolumn{1}{c|}{} & 指標 & \multicolumn{1}{ c| }{適應值} & \multicolumn{1}{ c| }{權重} \\\cline{2-4}
    \multicolumn{1}{c|}{} & \multicolumn{3}{ c| }{總適應值} \\\hline
    #4
    \end{tabular}
  \end{minipage}
  \begin{minipage}[t]{0.48\linewidth}
...
本章節將探討前述章節之方法是否符合研究目標，將進行以下實驗：第~\ref{sec:experiment-results} 小節中，針對所挑選的房間採用不同權重的適應性函數，其世代數量、個體數量會如何影響房間內的遊戲物件之配置結果。
...
\garesultstable{A1}
  ...
  {10}
  {
    \multirow{3}{*}{$1$}  & 守衛點 & $0.7002$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.7002$} \\\hline
    \multirow{3}{*}{$2$}  & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
    \multirow{3}{*}{$3$}  & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
    \multirow{3}{*}{$4$}  & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
    \multirow{3}{*}{$5$}  & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
  }
  {
    \multirow{3}{*}{$6$}  & 守衛點 & $0.7002$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.7002$} \\\hline
    \multirow{3}{*}{$7$}  & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
    \multirow{3}{*}{$8$}  & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
    \multirow{3}{*}{$9$}  & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
    \multirow{3}{*}{$10$} & 守衛點 & $0.6661$ & $1$ \\\cline{2-4}
                          & 密度   & $1.0000$ & $1$ \\\cline{2-4}
                          & \multicolumn{3}{ r| }{$1.6661$} \\\hline
  }
