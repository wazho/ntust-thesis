...
然而各個房間容器的適應性函數之權重如何決定？將取決於關卡設計師對於該房間容器預期產出進行調整，若希望該遊玩特徵指標能愈出現於房間容器，則將其權重調高；反之，愈不希望該遊玩特徵指標出現在房間容器，則將其權重調低；若不理會該遊玩特徵指標的體現與否，則將其權重設定為 $0$。在本次研究的系列實驗中，將以關卡設計師視角進行權重的指派，並不代表實驗中所使用的權重最能夠體現其房間容器。
