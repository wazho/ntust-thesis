...
% Salmon editted. Support the Chinese indent for the first line.
\usepackage{indentfirst}

% Salmon editted. Support the hyperlink reference.
% \usepackage[hidelinks]{hyperref}

% Salmon editted. Support the long table to change pages.
\usepackage{longtable}
% Salmon editted. Specifying your column width with m{...}.
\usepackage{array}
...
% Salmon editted. Support the pseudocode.
